...
ESCRITURA PÚBLICA: [[PENDIENTE: NUMERO_EP_EN_LETRAS]]
NUMERO: ([[PENDIENTE: NUMERO_EP]])
...
DEL OBJETO LICITO: El (la, los) compareciente(s) manifiesta(n) que el objeto del presente negocio o acto jurídico se encuentra enmarcado dentro de las normas legales vigentes, que no contraviene la ley, que los bienes, cosas y derechos que se comprometen en esta transacción jurídica, están dentro del mercado comercial y de la vida jurídica y están sujetos al principio de la oferta y la demanda por no existir sobre los mismos anotaciones o decisiones que prohíban la enajenación o gravamen, embargo o medida cautelares vigente.
...
DE LA IDENTIFICACIÓN: El (la, los) compareciente(s) manifiesta(n) que los documentos de identidad que exhiben para suscribir el presente instrumento son auténticos, se encuentran vigentes y corresponden a su verdadera identidad, en todo caso que el (la, los) compareciente(s) presente(n) para su identificación contraseña que señale el trámite de duplicado, corrección o rectificación, el ciudadano afirma bajo la gravedad de juramento que el sello que certifica el estado de su trámite ha sido estampado en una oficina de la registraduría nacional del estado civil, en todo caso los titulares de contraseñas de expedición de cédula de ciudadanía por primera vez, o no certificadas, las cédulas de extranjería, pasaportes o visas que no pueden ser sometidas al control de captura de identificación biométrica, manifiestan que estos documentos han sido tramitados y expedidos por la entidad competente y legítimamente constituida para ello (registraduría, consulado, das, embajadas, etc.) y que no ha sido adulterada o modificada dolosamente. Las declaraciones consignadas en este instrumento corresponden a la verdad, el(los) otorgantes lo aprueban totalmente, sin reserva alguna, en consecuencia, asumen la responsabilidad de cualquier inexactitud. La notaria no puede dar fe sobre la voluntad real del(los) comparecientes y beneficiaros, salvo lo expresado en este instrumento, que fue aprobado sin reserva alguna por el(los) comparecientes y beneficiarios en la forma como quedo redactado. Conocen la ley y saben que la notaria responde de la regularidad formal de los instrumentos que autoriza, pero no de la veracidad de las declaraciones del(los) otorgantes ni de la autenticidad de los documentos que forman parte de este instrumento.

CLÁUSULA DE CONOCIMIENTO: La Notaria en ejercicio del control de legalidad que le asiste advierte a las partes intervinientes en el negocio jurídico de la importancia de verificar previamente la identidad, condiciones legales de los otorgantes. Las partes así lo han constatado y se reconocen como contratantes por previo, anterior y personal conocimiento. La identidad de cada una de las partes ha sido comprobada basándose en la autenticaciones y veracidad de sus documentos de identificación, exonerando por lo tanto al notario y sus funcionarios de toda responsabilidad ante una eventual suplantación de identidad, dado que el notario ha tomado igualmente mediadas de seguridad como registro en el sistema biométrico en el que se consigna electrónicamente la imagen fotográfica y la huella digital de los comparecientes, así como la digitalización del instrumento.

MANIFESTACIÓN DE LOS COMPARECIENTES: El(Los) compareciente(s) manifiesta(n) bajo la gravedad del juramento que hasta la fecha este inmueble no se encuentra inmerso en causales o motivos de la Ley de Víctimas y Restitución de Tierras (Ley 1448 de 2011), de igual forma manifiestan, que en el inmueble objeto del presente negocio jurídico no ha existido desplazamiento forzoso, despojo o abandono forzado de tierras, así como tampoco acción ilegal que genere aprovechamiento de la situación de violencia, tampoco ha sido fruto de ser privado arbitrariamente a una persona de su propiedad, posesión por vía de hecho y/o negocios apócrifos, actos administrativos, sentencia o mediante comisión de delitos asociados a la situación de violencia.

ADVERTENCIA NOTARIAL: A los otorgantes se les advirtió que una vez firmado este instrumento público La Notaria no asumirá correcciones o modificaciones si no en la forma y casos previstos por la ley siendo esto solo responsabilidad de los otorgantes. Además, la notaria les advierte a EL(LOS) COMPARECIENTE(S) que cualquier aclaración a la presente escritura, implica el otorgamiento de una nueva escritura pública de aclaración cuyos costos serán asumidos única y exclusivamente por EL(LOS) COMPARECIENTE(S). EL(LOS) COMPARECIENTE(S) hacen constar que han verificado cuidadosamente sus nombres completos, el número de su documento de identidad. Declaran que todas las informaciones consignadas en el presente instrumento son CORRECTAS y, que en consecuencia asumen la responsabilidad que se derive de cualquier inexactitud en las mismas. Conocen la ley y saben que La Notaria responde de la regularidad formal de los instrumentos que autoriza, pero NO de la veracidad de las declaraciones de los interesados. Se les advierte a los otorgantes de la formalidad del Registro en la oficina correspondiente dentro del término perentorio de dos (2) meses contados a partir de la fecha de otorgamiento de este instrumento, cuyo incumplimiento causará interés moratorio por mes o fracción de mes de retardo, de conformidad con el Art.37 del Decreto ley 960 de 1.970. De igual forma se les advierte a los otorgantes que deben tener en cuenta lo señalado en el artículo ARTICULO 1947 del C.C. Colombiano.
