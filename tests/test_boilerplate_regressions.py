...
def test_caratula_template_keeps_property_header_fields():
    assert "RADICADO: [[NUMERO_RADICADO]]" in EP_CARATULA_TEMPLATE
    assert "ESCRITURA PÚBLICA: [[PENDIENTE: NUMERO_EP_EN_LETRAS]]" in EP_CARATULA_TEMPLATE
    assert "NUMERO: ([[PENDIENTE: NUMERO_EP]])" in EP_CARATULA_TEMPLATE
    assert "FECHA: [[PENDIENTE: FECHA_OTORGAMIENTO]]" in EP_CARATULA_TEMPLATE
    assert "FORMULARIO DE CALIFICACIÓN" in EP_CARATULA_TEMPLATE
    assert "CLASE DE ACTO:" in EP_CARATULA_TEMPLATE
    assert "OTORGADA EN LA NOTARIA:" not in EP_CARATULA_TEMPLATE
    assert "CIRCULO NOTARIAL:" not in EP_CARATULA_TEMPLATE
